...
const ContactForm = () => {
    ...
    return (
        <Container style={{backgroundColor:"white",border:"1px solid black",padding:"20px",borderRadius:"10px",margin:"50px 12px"}}>
            <Form  ref={formRef} onSubmit={handleSubmit}>
                ...
                <Button style={{ float: "right", backgroundColor:"var(--yellow-bg)", color:"black"}} variant="success" type="submit">
                    Gửi
                </Button>
            </Form>
        </Container>
